...
Vagrant.configure("2") do |config|
  ...
  # unless NFS is used. There seems to be some problem with softlinks somehow.
  # 2) Not using NFS is slow: VirtualBox shared folders have high performance
  # penalties. (On my computer, running `play exit` takes 20 seconds without
